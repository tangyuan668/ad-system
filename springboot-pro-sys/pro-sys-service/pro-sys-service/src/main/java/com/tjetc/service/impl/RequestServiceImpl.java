...
public class RequestServiceImpl implements RequestService {
    ...
    @Override
    public JsonResult findRequestPage(String title, Integer pageNo, Integer pageSize) {
        //设置页码和每页数量
        Page<Request> page = Page.of(pageNo, pageSize);
//把adminPage传入mapper查询中，adminPage就是分页结果
        Page<Request> requestPage =  requestMapper.selectRequestPageLikeTitle(page,title);
