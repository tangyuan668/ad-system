<template>
    <el-form :model="deliverForm" label-width="120px">
      ...
      <el-form-item label="广告制作需求号">
        <el-input v-model="deliverForm.requestId" />
      </el-form-item>

      <el-form-item label="名字">
        <el-input v-model="deliverForm.name" />
      </el-form-item>


      <el-form-item label="广告设计图" >
  ...
  <!-- 上传图片成功之后的回显 -->
    ...
    <el-icon v-else class="avatar-uploader-icon"><Plus /></el-icon>
      ...
      <el-form-item label="状态" >
        <el-select v-model="deliverForm.status" disabled >
      ...
      <el-form-item label="建议">
        <el-input v-model="deliverForm.advice" type="textarea" :rows="4"   disabled/>
      </el-form-item>
...
router.push('/adProducer/deliver');
}
else{
  ElMessage({
