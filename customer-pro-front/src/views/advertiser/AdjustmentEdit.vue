<template>
    <el-form :model="adjustmentForm" label-width="120px">
        ...
        <el-input v-model="adjustmentForm.designId" />
      </el-form-item>
      <el-form-item label="调整标题">
        <el-input v-model="adjustmentForm.name" />
      </el-form-item>
      <el-form-item label="内容">
        <el-input v-model="adjustmentForm.content" type="textarea" :rows="4" />
      </el-form-item>

      <el-form-item label="状态">
        <el-select v-model="adjustmentForm.status" disabled>
