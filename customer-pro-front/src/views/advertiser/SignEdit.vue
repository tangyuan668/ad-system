<template>
  <div class="form-container">
    ...
    <div class="signature-content">
      <!-- 客户签名或签名板 -->
      <el-form-item v-if="!route.query.id" label="广告商签名">
      ...
      <el-form-item v-else label="广告商签字">
        <div class="signature-container">
          <el-image
...
const uploadSignature = () => {
  ...
  const headers = {
    'token': useAdvertiserStore().getToken,
  };
  ...
  .then(response => {
    ...
    signForm.advertiserSignature = response.data.data; // 将图片路径赋值给 signForm.advertiserSignature
