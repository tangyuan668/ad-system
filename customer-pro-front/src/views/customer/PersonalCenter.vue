...
import {findById,save}  from '@/api/customer';
...
onMounted(() =>{
 ...
 ruleForm.id=customerStore.customer.id
 console.log(`output->ruleForm.id`,ruleForm.id)
//console.log(`CustomerSaveView`,id)
...
customerStore.customer.imagePath=ruleForm.imagePath
