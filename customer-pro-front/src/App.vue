  ...
  <div class="layout">
    ...
    :default-active="dataInfo.currentPath">
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item-group>
              <el-menu-item index="/customer/login">
                <a href="http://localhost:5174/admin/login" target="_blank">
                  <el-icon>
                    <Sell />
                  </el-icon>
                  管理员
              ...
              <el-menu-item index="/advertiser/login">
                <el-icon>
                  <Sell />
                </el-icon>
                广告商
              </el-menu-item>
              <el-menu-item index="/adProducer/login">
                <el-icon>
                  <Sell />
                </el-icon>
                广告制作商
